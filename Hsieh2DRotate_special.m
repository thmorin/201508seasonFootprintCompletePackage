...
function [foot,xx,yy,footRotate,Fxprime,Fyprime,footsum,timesteps]=Hsieh2DRotate_special(ustar,Lo,sv,zo,zH, d, windir, plotYN, FX, FY, F,timesteps)
...
if plotYN==1
figure(gcf);%     figure(2)
contour(FX2,FY2(Rl:-1:1,:),footRotate,'LevelStep',0.00002,'Fill','off');shading('interp') 
